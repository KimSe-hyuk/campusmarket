...
<div style="display: none;" id="userDiv">
    ...
    $query = $db->query("select * from board_$bid i INNER JOIN dips d on i.object_num = d.object_num where object_category like '%$category%' and share like '%$share%' order by i.object_num desc ");
