...
<div style="display: none;" id="userDiv">
    ...
    $query = $db->query("select * from board_$bid where member_num=$userNum and share='구매' and object_category like '%$category%' and share like '%$share%' order by object_num desc");
